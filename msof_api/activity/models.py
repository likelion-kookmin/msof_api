...
class Activity(BaseModel):
    ...
    # TODO: 0012 created_at을  __str__에 추가하기   # pylint: disable=fixme
    def __str__(self):
        # pylint: disable=E1101
        return "{0}님이 {1} 행동을 통해 {2}점을 얻었습니다.".format(
            self.user.username, self.point_rule.name, self.point_rule.point
        )
