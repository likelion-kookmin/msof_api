    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "deleted_at",
                    models.DateTimeField(default=None, null=True, verbose_name="삭제된 일시"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("질문 등록", "register_question"),
                            ("댓글 채택", "adopt_comment"),
                            ("채택받은 댓글", "adopted_comment"),
                            ("회원가입", "signup"),
                            ("좋아요받은 댓글", "liked_comment"),
